...
function reviewCommand(vaultRoot, command, options) {
  ...
  if (command === 'add') {
    ...
    const review = {
      ...
      summary,
      food_rank: numberOption(options, 'food_rank', null),
      scenery_rank: numberOption(options, 'scenery_rank', null),
      experience_rank: numberOption(options, 'experience_rank', null),
  ...
  if (command === 'update') {
    ...
    const next = {
      ...
      food_rank: numberOption(options, 'food_rank', entry.frontmatter.food_rank ?? null),
      scenery_rank: numberOption(options, 'scenery_rank', entry.frontmatter.scenery_rank ?? null),
      experience_rank: numberOption(
        options,
        'experience_rank',
        entry.frontmatter.experience_rank ?? null,
      ),
