            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="min-h-10 shrink-0 rounded-lg bg-stone-950 px-3 py-2 text-xs font-medium text-white transition hover:bg-stone-800 disabled:cursor-not-allowed disabled:bg-stone-300"
                >
                  {t('restore')}
                </button>
              </div>
