    ...
    <>
      <button
        ...
        className={variant === 'segmented'
          ? 'px-2.5 py-1.5 text-xs font-medium transition hover:bg-stone-100 hover:text-stone-700 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-stone-400'
