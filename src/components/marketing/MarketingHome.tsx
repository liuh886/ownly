...
const copy = {
  en: {
    ...
    proof: ['Local Markdown', 'No required account', 'Backup and restore'],
    ...
    localTitle: 'Your facts remain useful outside Ownly.',
    localText:
      'Records stay in readable Markdown with YAML frontmatter. The Web/PWA, Obsidian plugin and Agent CLI use the same local data model.',
    trust: ['Markdown + YAML', 'No hosted personal database', 'Versioned backup', 'Portable across tools'],
    finalTitle: 'Know what deserves to stay.',
    finalText: 'Start with one real object. Keep the record on your device from day one.',
    github: 'GitHub',
  ...
  zh: {
    ...
    seeHow: '查看工作方式',
    proof: ['本地 Markdown', '无需强制账户', '备份与恢复'],
    overviewLabel: '所有权总览',
    today: '今天',
    ...
    localTitle: '即使离开 Ownly，你的事实仍然有用。',
    localText:
      '记录以可读的 Markdown 与 YAML frontmatter 保存。Web/PWA、Obsidian 插件和 Agent CLI 使用同一套本地数据模型。',
    trust: ['Markdown + YAML', '无托管个人数据库', '版本化备份', '可迁移到其它工具'],
    finalTitle: '看清什么值得留下。',
    finalText: '从一个真实对象开始，记录从第一天起就留在你的设备中。',
    github: 'GitHub',
