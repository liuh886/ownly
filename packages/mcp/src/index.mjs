  ...
  server.registerTool(
    'ownly_planner_prepare_set_travel_leg',
    {
      ...
      inputSchema: z.object({
        ...
        mode: z.enum(['driving', 'motorcycle', 'walking', 'bicycling', 'transit']),
  ...
  server.registerTool(
    'ownly_planner_prepare_add_expense',
    {
      ...
      inputSchema: z.object({
        ...
        category: z.enum(['stay', 'food', 'cafe', 'transit', 'transport', 'ticket', 'attraction', 'experience', 'shopping', 'service', 'other']),
