...
### Web App（非 Obsidian 用户 & 开发者）

如果你不使用 Obsidian，可以将 Ownly 作为独立 Web 应用运行。它在浏览器中运行，通过 File System Access API 连接本地文件夹。
...
可以。Web App 在任何现代浏览器中运行，连接本地文件夹即可使用。参见 [Web App 安装](#web-app非-obsidian-用户--开发者)。
