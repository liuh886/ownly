...
Ownly `1.x` 是稳定的公开 Obsidian 插件版本。Obsidian 插件是主要支持的使用形态；Web runtime 保留用于本地浏览器使用、开发调试和共享核心层验证。
...
Ownly 采用赞助模式。它不做付费许可证联网校验，也不会为激活功能发起网络请求。免费用户始终拥有完整的 Markdown 数据访问权限 —— Ownly 永远不会因许可状态而锁定、加密、删除或阻止导出数据。
...
> **注意：** 当前版本（1.x）采用赞助模式。Pro 功能可用 App 中展示的免费激活码解锁；通过 [Ko-fi](https://ko-fi.com/F1F7WYJ6B) 或 [Gumroad](https://liuh886.gumroad.com/l/ownly) 支持项目是可选的，用于资助后续开发。
